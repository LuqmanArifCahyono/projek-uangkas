...
public final class uang_kas extends javax.swing.JFrame {
    ...
    Connection cn = koneksiDB.koneksi.setkoneksi();
    ...
    public void judul(){
        Object[] judul = {"NIS","Nama","J. Kelamin","rombel","Tanggal"};
    ...
    private void initComponents() {
        ...
        crombel = new javax.swing.JTextField();
        ...
        jPanel3.add(tnis, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 21, 100, -1));
        ...
        cuang.setBackground(new java.awt.Color(255, 255, 255));
        ...
        cbayar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        ckembalian.setBackground(new java.awt.Color(255, 255, 255));
        ...
        bloguss.setBackground(new java.awt.Color(255, 255, 255));
        bloguss.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        bloguss.setForeground(new java.awt.Color(0, 0, 0));
        ...
        breport.setForeground(new java.awt.Color(0, 0, 0));
        ...
        crombel.setBackground(new java.awt.Color(255, 255, 255));
        crombel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        crombel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                crombelActionPerformed(evt);
            }
        });
        crombel.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                crombelKeyTyped(evt);
            }
        });
        jPanel3.add(crombel, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 103, 108, -1));

        tb_sak.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        if(tnis.getText().equals("") || tnama.getText().equals("") || cbayar.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Harap Lengkapi Data!");
        }else{
            try{
                st = cn.createStatement();
                st.executeUpdate("insert into tbl_kas set nis='" + tnis.getText()+ "', nama='" +tnama.getText()+ "', rombel='" +crombel.getText()+ "', u_bayar='" +cbayar.getText()+ "', kembalian='" +ckembalian.getText() + "'," + "tgl='"+ jTextField1.getText()+ "'");
                st.executeUpdate("update tb_siswa set ket='sudah' where nis='"+tnis.getText()+"'");
    ...
    private void crombelKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_crombelKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_crombelKeyTyped
    ...
    private void breportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_breportActionPerformed
        ...
        new laporankas().setVisible(true);
//         String reportSource = null;
//        String reportDest = null;
//        
//        try{
//            reportSource = "D:\\New Volume(D:)\\Download\\jasper\\report1.jrxml";
//            reportDest = "D:\\New Volume(D:)\\Download\\jasper\\report1.jasper";
//            
...
//        }
    ...
    private void crombelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crombelActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_crombelActionPerformed
    ...
    private javax.swing.JTextField crombel;
